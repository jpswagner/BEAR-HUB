...
# File: bearhub.cpython-311.pyc (Python 3.11)
...
app = rx.App(theme = rx.theme(accent_color = 'teal', gray_color = 'slate', radius = 'large', appearance = 'light'))
app.add_page(hub_page, route = '/', title = 'BEAR-HUB')
app.add_page(bactopia_page, route = '/bactopia', title = 'Bactopia — BEAR-HUB', on_load = BactopiaState.init_outdir)
app.add_page(tools_page, route = '/tools', title = 'Bactopia Tools — BEAR-HUB', on_load = ToolsState.init_outdir)
app.add_page(merlin_page, route = '/merlin', title = 'MERLIN — BEAR-HUB', on_load = MerlinState.init_outdir)
